...
- sLM에서 orchestration이 성능을 얼마나 증폭시키는지 정량적으로 분석하고, 그 증폭 효과의 구조적 차이를 비교

> Q. orchestration은 single-shot 대비 얼마나 성능을 증폭시키는가?
> Q. 어떤 구조가 가장 큰 성능 향상을 제공하는가?
> Q. 성능 향상은 비용(latency)을 고려했을 때 얼마나 효율적인가?
...
본 실험에서는 다양한 orchestration 전략을 구성하고, 각 구조가 sLM 성능을 얼마나 증폭시키는지와 구조별 성능–비용 trade-off를 비교한다.
...
#### (2) Simple Orchestration Structures
단순한 orchestration 구조를 통해 sLM에서의 기본적인 성능 증폭 효과를 관찰
