...
from src.evaluation.executor import execute_bigcode, ExecutionResult
...
class BigCodeAdapter(BaseAdapter):
    ...
    def execute(self, sample: BigCodeSample, code: str) -> ExecutionResult:
    ...
    def classify_execution(self, exec_result: ExecutionResult) -> Dict[str, Any]:
        """
        BigCode execution 결과를 ver3 공통 포맷으로 변환한다.
